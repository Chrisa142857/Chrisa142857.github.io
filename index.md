...
Recently I have submitted a preprint paper to the journal **Medical Image Analysis**, and have been working on an on-going in-the-wild emotion recognition competition associated with **ICCV 2021**. Our model on the validation set significantly outperforms the baseline and the champion of last year. 
